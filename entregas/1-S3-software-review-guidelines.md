...
#### CU-09: Gestión de Facturas y Pagos (simulado)
| Nombre | Descripción | Estado |
| :--- | :--- | :--- |
...
| Notificaciones de Pagos | El sistema debe enviar notificaciones push automáticas en los siguientes eventos: (a) nueva factura registrada — a todos los inquilinos participantes; (b) pago recibido — al Casero, indicando quién pagó y el importe; (c) recordatorio de vencimiento — al Inquilino, 3 días antes y el mismo día del vencimiento; (d) pago vencido — al Inquilino diariamente tras el vencimiento y al Casero una vez; (e) auto-pago ejecutado — al Inquilino confirmando el cargo. Todas las notificaciones deben ser también visibles en un centro de notificaciones in-app. | Completado (las notificaciones se ven dentro del perfil) |
...
| RF-ID | Nombre | Descripción | Estado |
| :--- | :--- | :--- | :--- |
| **RF-63** | Registro con email y contraseña | El sistema debe ofrecer un formulario de registro (email, contraseña, confirmar contraseña), validar formato de email (regex) y unicidad, validar la política de contraseña configurable (mín. 4 caracteres u equivalente), comprobar coincidencia de contraseña/confirmar. | Completado |
...
| **RF-68** | Completar y editar perfil | El sistema debe permitir completar/editar: fotos de perfil, nombre, fecha de nacimiento (validar y calcular edad), género, teléfono, estudio/trabajo, descripción libre y preguntas de convivencia con opciones predefinidas (ej. Fumar: Sí/No/Ocasional). | Completado |
...
| :--- | :--- | :--- |
| *ej., La página de inicio de sesión es lenta* | *ej., Optimización de la consulta a la base de datos* | *ej., El tiempo de carga se redujo en 2 segundos* |
